...
from awslabs.amazon_msk_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.amazon_msk_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.amazon-msk-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.amazon_msk_mcp_server import server
